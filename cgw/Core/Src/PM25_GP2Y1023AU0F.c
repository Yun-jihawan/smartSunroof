...
uint32_t pulseIn(GPIO_TypeDef* port, uint16_t pin, GPIO_PinState state, uint32_t timeout_us)
{
...
{
    uint32_t duration_us = pulseIn(sensor->port, sensor->pin, GPIO_PIN_RESET, 100000); // 최대 100ms 대기
